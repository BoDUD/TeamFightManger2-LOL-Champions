...
- Run: eight stable cross-step frames preserve the native frame count and 0.065 s timing while following the Viktor reference principle: upright torso, tiny foot alternation, consistent body height, and a fixed bottom safety area.
