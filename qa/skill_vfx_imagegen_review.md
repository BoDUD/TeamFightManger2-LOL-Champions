...
- Thresh R follow-up: The Box must read as a terrain prison, not an aura attached to Thresh. The 2026-06-12 target-ground pass replaces the old `RangeEffect`/`AroundCaster` ult with a `ParabolicProjectile` ground anchor whose end effects spawn the box wall VFX and long-lived field at the target terrain point.
